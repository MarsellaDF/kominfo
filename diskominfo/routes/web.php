...
Route::resource('pengajuankeberatan',App\Http\Controllers\PengajuankeberatanController::class);
...
Route::resource('detail-berita',App\Http\Controllers\ArticleController::class. "@show");
