...
class BannerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $imageurl = $banners->filename_banners;
        ...
        if ($request->hasFile('image')) {
            ...
            $file = 'upload/banner/' . $banners->filename_banners;
            if ($banners->filename_banners != '' && $banners->filename_banners != null) {
                unlink($file);
            }
        }
