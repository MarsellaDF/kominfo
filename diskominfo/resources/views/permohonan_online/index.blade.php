                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input name="nik" type="text" class="form-control" maxlength="16"
                                            data-minlength="16" id="exampleFormControlInput1" placeholder="35**************"
                                            value="">
                                        @error('nik')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="text" class="form-control" value=""
                                            id="exampleFormControlInput1" placeholder="Nama Lengkap Anda">
                                        @error('nama')
                                            <div class="text-danger">* {{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="address" type="text" class="form-control" value=""
                                            id="exampleFormControlInput1" placeholder="Isikan Alamat Lengkap Anda">
                                        @error('alamat')
                                            <div class="text-danger">* {{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="email" type="text" class="form-control" value=""
                                            id="exampleFormControlInput1" placeholder="Isikan Email Anda">
                                        @error('email')
                                            <div class="text-danger">* {{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="jobs" type="text" class="form-control" value=""
                                            id="exampleFormControlInput1" placeholder="Isikan Pekerjaan Anda">
                                        @error('pekerjaan')
                                            <div class="text-danger">* {{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="telepon" type="text" class="form-control" maxlength="13"
                                            data-minlength="13" id="exampleFormControlInput1" placeholder="62***********"
                                            value="">
                                        @error('nomor')
                                            <div class="text-danger">* {{ $message }}</div>
                                        @enderror
    ...
    @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="ktp" type="file" class="form-control"
                                            value="{{ old('ktp') }}" id="exampleFormControlInput1" accept="image/*"
