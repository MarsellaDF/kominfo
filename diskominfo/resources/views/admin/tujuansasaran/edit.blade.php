@extends('admin.tujuansasaran.layout')

@section('content')
<h2>Form Edit Tujuan dan Saran</h2>
<div class="container" style="padding: 24px; background-color:white">
    <form method="post" action="{{ route('tujuansasaran-admin.update', $tujuanSasaran->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-body">
                ...
                <div class="col mb-0">
                    <div class="form-check mt-3">
                        ...
                        <input type="checkbox" value="1" class="form-check-input" id="scales" name="status"
                            {{ isset($tujuanSasaran->status) && $tujuanSasaran->status == true ? 'checked' : '' }}>
            ...
            <div class="row g-2" style="margin-top: 16px">
                <div class="col mb-0">
                    @if (isset($tujuanSasaran->file))
                    <img width="200px" id="blah" src="{{ '/upload/tujuansasaran/' . $tujuanSasaran->file }}" alt="your image" />
                    @else
        ...
        <div class="modal-footer">
            <a href="/tujuansasaran-admin" class="btn btn-outline-secondary">Close</a>
