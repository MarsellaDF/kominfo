@extends('admin.kedudukan.layout')

@section('content')
<h2>Form Edit Kedudukan Tugas Fungsi</h2>
<div class="container" style="padding: 24px; background-color:white">
    <form method="post" action="{{ route('kedudukan-admin.update', $kedudukan->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-body">
                ...
                <div class="col mb-0">
                    <div class="form-check mt-3">
                        ...
                        <input type="checkbox" value="1" class="form-check-input" id="scales" name="status"
                            {{ isset($kedudukan->status) && $kedudukan->status == true ? 'checked' : '' }}>
            ...
            <div class="row g-2" style="margin-top: 16px">
                <div class="col mb-0">
                    @if (isset($kedudukan->file))
                    <img width="200px" id="blah" src="{{ '/upload/kedudukan/' . $kedudukan->file }}" alt="your image" />
                    @else
        ...
        <div class="modal-footer">
            <a href="/kedudukan-admin" class="btn btn-outline-secondary">Close</a>
