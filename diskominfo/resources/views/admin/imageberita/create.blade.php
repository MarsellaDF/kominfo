@extends('admin.imageberita.layout')

@section('content')
    <div class="container" style="padding: 24px; background-color:white">
        <form method="post" action="{{ url('imageberita-admin')}}" enctype="multipart/form-data">
            @csrf
            <div class="body">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="modal-footer">
                    <a href="/imageberita-admin" class="btn btn-outline-secondary">Close</a>
