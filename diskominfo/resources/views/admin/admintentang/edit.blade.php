@extends('admin.admintentang.layout')

@section('content')
<h2>Form Edit Tentang Diskominfo</h2>
<div class="container" style="padding: 24px; background-color:white">
    <form method="post" action="{{ route('admintentang-admin.update', $adminTentang->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-body">
                ...
                <div class="col mb-0">
                    <div class="form-check mt-3">
                        ...
                        <input type="checkbox" value="1" class="form-check-input" id="scales" name="status"
                            {{ isset($adminTentang->status) && $adminTentang->status == true ? 'checked' : '' }}>
            ...
            <div class="row g-2" style="margin-top: 16px">
                <div class="col mb-0">
                    @if (isset($adminTentang->file))
                    <img width="200px" id="blah" src="{{ '/upload/admintentang/' . $adminTentang->file }}" alt="your image" />
                    @else
        ...
        <div class="modal-footer">
            <a href="/admintentang-admin" class="btn btn-outline-secondary">Close</a>
